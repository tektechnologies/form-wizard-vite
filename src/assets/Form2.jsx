     ...
     <div className="lay-container">
      <form className="form-container" onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="document-para section-width-paragraphs">Each person has an ethical responsibility to provide the highest level of pig care. The mistreatment of an
            animal is defined, but not limited to:
          </p>
          <div className="numbered-section-margin">
            <div className="container">
                <span className="ellipse">1</span>
                <p className="document-para form-2-list-items">Physical or verbal abuse, violence, or acts of aggression towards animals. This includes, the malicious use of any object or substance to cause unnecessary pain and suffering</p>
            </div>
            <div className="container">
                <span className="ellipse">2</span>
                <p className="document-para form-2-list-items">Failure to manage ventilation and environment to prevent animal exposure to temperature extremes and poor air quality</p>
            </div>
            <div className="container">
                ...
                <p className="document-para form-2-list-items">Failure to move animals as outlined in Pork Quality Assurance Plus (PQA+) and/or Transport
                  Quality Assurance (TQA) resulting in increased stress on the animal
                </p>
            </div>
            <div className="container">
                <span className="ellipse">4</span>
                <p className="document-para form-2-list-items">Failure to identify and treat sick pigs. This includes failure to relocate a sick or non-competitive pig to a more suitable location.</p>
            </div>
            <div className="container">
                ...
                <p className="document-para form-2-list-items">Failure to comply with the BP treatment & vaccination guidelines as provided by the Veterinary
                  Client Patient
                  Relationship (VCPR). This includes failure to maintain accurate treatment records.
                </p>
            </div>
            <div className="container">
          ...
          <div className="section-width-paragraphs">
            <p className="document-para">Correct animal care is covered, in detail, in National Pork Board's Pork Quality Assurance Plus (PQA+) and
                ...
                included in both the PQA+ Site Assessment and Common Swine Industry Audit.
            </p>
            <p className="document-para">Under no circumstances will animal abuse or neglect be tolerated. Any individual who witnesses the
                ...
                24 hours. Failure to report animal abuse or neglect will result in disciplinary action up to and including immediate termination or loss of contract privileges.
            </p>
            <p className="document-para">Door Access System recognizes possible criminal implications of non-compliance with this policy and reserves
                ...
                current or former, as it relates to accusations of animal abuse or neglect. 
            </p>
          </div>
          <hr
          style={{
